...
public class AgatePage extends BasePage {
    ...
    public AgatePage() {
        ...
        locatorMap.put("tripTypeDropdown", "(//button[contains(@id,'flm-flight-tripType')])[1]");
        locatorMap.put("tripTypeOW", "//li[contains(@id,'flm-flight-tripType-item-1')]");
        ...
        locatorMap.put("dateNextArrow",
                "(//i[contains(@class,'icon lh lh-arrow-right') or contains(@class,'icon lh lh-arrow-next')])");
        locatorMap.put("calenderContinue", "//span[contains(text(),'Continue')]");
        ...
        locatorMap.put("adultPaxPlusBtn", "//button[@class=\"btn-link mb-0 btn-plus border-left-0\"]");
        ...
        locatorMap.put("searchFightsButton", "//div[contains(@id,'flightmanager')]//span[contains(text(),'Search')]");
        ...
        locatorMap.put("bookingCode", "//*[contains(@id,\"Bookings-section\")]//input[@placeholder='Booking code']");
        locatorMap.put("bookingLastName",
                "//*[contains(@id,\"Bookings-section\")]//input[contains(@id,'mybookings-bookingQuery.lastName')]");
        locatorMap.put("findBookingsButton",
                "//*[contains(@id,\"Bookings-section\")]/div/div/form//button[@type='submit']");
        ...
        locatorMap.put("departureReturnDateField", "//input[@placeholder='Departure - return']");
        ...
        infoMap.put("searchFightsButton", "Button to Search Flight Availability");
...
//    public void LoginAgate() throws InterruptedException {
//
////        long totalTimeout = (elementVisibilityMinTimeout * elementVisibilityMaximumRetry) * 1000; // Total timeout for
//        // all pop-ups in
//        // milliseconds
...
//    }
    ...
    public void searchForFlights(String tripType, String origin, String destination, String outboundDate,
        ...
        takeExtraScreenshot();
        clickOnTheElement("searchFightsButton");
        takeExtraScreenshot();
    ...
    public void activateCitySelectionDropDownFlightSearch(String origin) throws InterruptedException, IOException {
         ...
         */
        try {
//            waitAndClickOnTheElement("hotelTab", elementVisibilityMaxTimeout);
//            waitAndClickOnTheElement("flightsTab", elementVisibilityMaxTimeout);
...
//    prem
    // This method helps to click on the dynamic element with values passed
//    public void clickElementwithlocator(String objectKey, String objectname) {
//        try {
//            validateElementnotDisplayed("LoadingImage", 30);
//            System.out.println(objectKey);
//            waitForElementLoadwithlocator(objectKey);
//            getElementByHandlewithlocator(objectKey).click();
//            logInfoStatus("Info | Clicked on : " + objectname);
//            page.waitForLoadState();
//        } catch (Exception e) {
//            e.printStackTrace();
//            String errMsg = "unable to find element : " + objectname + ". " + e.getMessage();
//            LOGGER.error(errMsg);
//            logAssert_Fail("\r\n" + "unable to find element : " + objectname);
//        }
//    }
    @Override
